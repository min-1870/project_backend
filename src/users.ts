...
/**
  ...
  * @param {string} token - an object that represents the right to perform certain actions
  *
  * @param {string} imgUrl - url of image uploaded by user
  *
  * @param {string} xStart - x component of a bound of image
  *
  * @param {string} yStart - y component of a bound of image
  *
  * @param {string} xEnd - x component of a bound of image
  *
  * @param {string} yEnd - y component of a bound of image
  *
